...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/24 11:15:53 by aazdoev           #+#    #+#             */
/*   Updated: 2023/01/24 11:26:53 by aazdoev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	print_img(t_player *data)
{
	...
	print_player(data);
	mlx_string_put(data->vars.mlx, data->vars.win, 20, 25, 0Xfffff, "MOVES: ");
	itoa = ft_itoa(data->movement);
	mlx_string_put(data->vars.mlx, data->vars.win, 90, 25, 0Xfffff, itoa);
	free(itoa);
	return (0);
}
