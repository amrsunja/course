...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/24 11:15:58 by aazdoev           #+#    #+#             */
/*   Updated: 2023/01/24 11:16:00 by aazdoev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_intro(t_player *data)
{
	...
	data->vars.win = mlx_new_window(data->vars.mlx, 1100, 800, "7enpai Game");
	data->sprite.intro.img = mlx_new_image(data->vars.mlx, 1100, 800);
